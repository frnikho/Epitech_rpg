...
static void load_setup_in_map(overworld_t *overworld, \
...
static int ***create_tiles_tab(overworld_t *overworld, char **layers)
{
...
static int ***create_objs_tab(overworld_t *overworld, char **layers)
{
...
static char **create_obs_tab(overworld_t *overworld, char **layers)
{
